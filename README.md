...
- [Components & committed capabilities](docs/components.md) — supervised effects, exact requirements, transactional reload, provider generations, and actor commitments.
